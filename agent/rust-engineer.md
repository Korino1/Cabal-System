...
- Если задача нерешаема/трудно решаема в текущем контексте, выполни дополнительный цикл поиска/рассуждений:
...
- В WORKLOG зафиксируй: что проверено на ZH/EN, какие гипотезы подтвердились/отпали, какой синтез выбран.
