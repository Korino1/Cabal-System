...
- Для математических обоснований (леммы/доказательства/ограничения) используется тройная проверка: RU → EN → ZH.
- Обязательна фиксация разночтений между языковыми версиями (термины/кванторы/ограничения/граничные условия).
- Итоговое решение принимается только после синтеза трёх версий (выбор лучшей или совокупный вариант с обоснованием).
...
- Дополнительные правила `YOLO` являются дополнением к существующим правилам секций 6.1..6.6 и не отменяют их.
...
- Нужна ли обязательная multilingual-проверка математики (RU/EN/ZH) и как разрешать разночтения между версиями?
...
- Если выбран `YOLO`, какие дополнительные сквозные правила нужно добавить к секциям 6.1..6.6 до активации режима?
