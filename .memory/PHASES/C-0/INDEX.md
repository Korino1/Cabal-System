...
- In-scope:
  ...
  - Дублирующая верификация концепта (EN, ZH, DE, FR) и синтез расхождений.
...
- Exit Criteria:
  ...
  - Проведены верификации EN/ZH/DE/FR и синтез расхождений (C-0.2..C-0.4) с фиксацией в `WORKLOG`.
