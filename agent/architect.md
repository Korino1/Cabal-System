...
4) Структура файлов, вложенность, библиотечные зависимости — зона исключительной ответственности architect.
...
- **Лимит циклов исправлений:** по одному и тому же несоответствию от Интегратора допускается не более 2 циклов INTEGRATOR→ARCH→INTEGRATOR. После 2 циклов — эскалация CONSULT к Пользователю с фиксацией решения как окончательного.
...
- Модули: ключевые компоненты и границы ответственности.
- Контракты: интерфейсы, ABI, входы/выходы, форматы данных.
- Data Layout: структура данных, alignment, SOA/AOS.
- Структура файлов: дерево каталогов проекта, вложенность модулей.
- Библиотеки и зависимости: список с версиями/источниками.
- Зависимости: библиотечные зависимости, внешние сервисы.
